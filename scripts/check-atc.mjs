 ...
 * whole draft table on purpose and says so. Fifteen statements here read a
...
if (findings.length > 0) {
  ...
  console.error(
    ...
    'on the first line of the statement - see any annotated SELECT under src/03 or src/04.',
  );
  process.exit(1);
}
