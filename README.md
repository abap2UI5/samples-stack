# abap2UI5 — samples-stack — RAP with Draft

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/04`](src/04) only, so
...
**Runs on:** Cloud + Standard ≥ 7.54 (1909)

## Setup

1. Install [abap2UI5](https://github.com/abap2UI5/abap2UI5).
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `04-rap-draft` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/04/README.md](src/04/README.md)**
