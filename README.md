# abap2UI5 — samples-stack — Business Events

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/05`](src/05) only, so
...
**Runs on:** Cloud + Standard ≥ 7.56 (2021)

RAP business events are younger than EML: the ABAP parses at 7.54, the feature
itself is there from 2021 on. If RAISE ENTITY EVENT does not activate on your
system, this package is out of reach.

## Setup

1. Install [abap2UI5](https://github.com/abap2UI5/abap2UI5).
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `05-business-events` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/05/README.md](src/05/README.md)**
...
- Built by [`create-package-branches.yaml`](https://github.com/abap2UI5/samples-stack/blob/main/.github/workflows/create-package-branches.yaml)
  ...
  this tree at `v754` before it was pushed.
