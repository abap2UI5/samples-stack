# abap2UI5 — samples-stack — RAP

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/03`](src/03) only, so
...
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `03-rap` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/03/README.md](src/03/README.md)**
