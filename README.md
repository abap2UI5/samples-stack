# abap2UI5 — samples-stack — Smart Controls

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/02`](src/02) only, so
...
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `02-smart-controls` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/02/README.md](src/02/README.md)**
