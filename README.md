# abap2UI5 — samples-stack — Stateful Sessions / Locks

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/06`](src/06) only, so
...
**Runs on:** Standard only, ≥ 7.40 SP08

## Setup

1. Install [abap2UI5](https://github.com/abap2UI5/abap2UI5).
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `06-stateful-locks` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/06/README.md](src/06/README.md)**
