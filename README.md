# abap2UI5 — samples-stack — AMC/APC

**One package, nothing else.** This branch is generated from
[`main`](https://github.com/abap2UI5/samples-stack/blob/main/README.md) and carries [`src/07`](src/07) only, so
...
2. Pull **this branch** with [abapGit](https://abapgit.org) — pick `07-amc-apc` in
   the branch dropdown.
3. Set up whatever the package builds on: **[src/07/README.md](src/07/README.md)**
